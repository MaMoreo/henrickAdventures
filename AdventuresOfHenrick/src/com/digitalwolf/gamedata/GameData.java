...
public class GameData {
	 ...
	 */
	 ...
	 private static int[] highscores = new int[] { 500, 100, 50, 20, 10 };
	    ...
	    private static final String PREFS_FILE_NAME = "chroniclesofpummadws";
	   ...
	   //THIS METHOD SAVES THE TOP 5 HIGHSCORES IN THE ARRAY highscores[i] UNDER THE KEY highscores1 .. 5
	    ...
	    public static void setSoundEnabled(boolean musicOn){
	    	 prefs.putBoolean("soundEnabled", musicOn);
	         prefs.flush();
	    }
		
	    //dude get from preferences
		...
		///////////
		 ...
		 public static void setSoundEnabled2(boolean effectOn){
	    	 prefs.putBoolean("soundEnabled2", effectOn);
	         prefs.flush();
	    }
		
	    //dude get from preferences

		public static boolean getSoundEnabled2() {
			// TODO Auto-generated method stub
			return prefs.getBoolean("soundEnabled2",true);
		}
		...
		public static boolean  isTimerOn() {
			// TODO Auto-generated method stub
			return prefs.getBoolean("isTimerOn",false);
		}

		public static void setTimer(boolean b) {
			prefs.putBoolean("isTimerOn", b);
	        prefs.flush();
		}		
